...
class Inflect
{
    ...
    public static function pluralize( $string )
    {
        ...
        if(!isset($ret))
        {
          ...
          foreach ( self::$irregular as $pattern => $result )
          {
              ...
              {
                  $ret = preg_replace( $pattern, $result, $string);
                  break;
                }
	...
	public static function genderize($Phrase='', $Gender="male"){
	     $ostring = $string;
        ...
        $string = str_replace($SearchValues, $ReplacementValues, $Phrase);
