...
$db['default']['database'] = "smilebooth";


/*
$db['default']['hostname'] = "external-db.s58878.gridserver.com";
$db['default']['username'] = "db58878";
$db['default']['password'] = "M6yu7pDi";
$db['default']['database'] = "db58878_swamped";
*/
...
define('DSN', $db[$active_group]['dsn']);
